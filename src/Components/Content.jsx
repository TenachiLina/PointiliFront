...
        ...prev,
        [employeeNum]: {
          // Ensure 'emp' is replaced with 'employeeNum' or defined correctly here,
          // though this part of the logic was missing 'emp' definition in original code
          // and relies on 'employeeTimes[employeeNum]' existing. Assuming original intent:
          ...prev[employeeNum], 
...
    const clockIn = getEmployeeTime(employeeNum, 'clockIn');
    // 🛑 FIX 3b: Use the current tab shift number for displaying delay/overtime
    const shiftNumber = currentTab; 
    const lateMinutes = calculateLateMinutes(clockIn, shiftNumber);
...
    const clockOut = getEmployeeTime(employeeNum, 'clockOut');
    // 🛑 FIX 3c: Use the current tab shift number for displaying delay/overtime
    const shiftNumber = currentTab; 
    const overtimeMinutes = calculateOvertimeMinutes(clockOut, shiftNumber);
...
{employees
  .filter((emp) => {
    // 🛑 FIX 1: Update filtering logic to support array of shifts
...
                  </td>
                  <td>
                    {/* 🛑 FIX 2: Display all assigned shifts, joined by a comma */}
                    <div style={{ 
                      textAlign: 'center', 
                      fontWeight: 'bold', 
                      fontSize: '16px',
